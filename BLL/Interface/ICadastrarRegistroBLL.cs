...
namespace BibliotecaViva.BLL.Interface
{
    ...
    {
        RegistroDTO PopularRegistro(string nome, string apelido, string latlong, string descricao, string conteudo, TipoDTO tipoSelecionado, OptionButton idiomaDropdown, int codigoRegistro);
